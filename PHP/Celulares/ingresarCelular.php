     ...
     <div class="preview-page">
				  ...
				  <div class="contact-form">
				  	<center><h3>Registrar Celular</h3></center>
					    <form method="post" action="script-GuardaCelular.php" enctype="multipart/form-data" >
					    	
					    	<label>Codigo Celular</label>
					    	<input type="text" name="codigocelular" class="form-control">
					    	<label>Marca</label>
					    	...
					    	<input type="text" name="procesadorghz" class="form-control">
					    	<label>Almacenamiento Externo</label>
					    	<input type="text" name="almexternogb" class="form-control">
					    	<label>Almacenamiento Interno</label>
					    	<input type="text" name="alminternogb" class="form-control">
					    	<label>Memoria</label>
					    	<input type="text" name="memoriagb" class="form-control">
					    	<label>Camara</label>
					    	<input type="text" name="camarampx" class="form-control">
					    	<label>Pantalla</label>
					    	<input type="text" name="pantallapx" class="form-control">
					    	<label>Sistema Operativo</label>
					    	<input type="text" name="sistoperativo" class="form-control">
					    	<label>Dimensiones</label>
					    	<input type="text" name="dimensionesm" class="form-control">
