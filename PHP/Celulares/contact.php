     ...
     <div class="preview-page">
				  ...
				  <div class="contact-form">
				  	<center><h3>Registrar Celular</h3></center>
					    <form method="post" action="script-GuardaCelular.php">
						    ...
						    <div>
						    	<span><textarea name="userMsg" value="Descripcion:" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message';}">Descripcion: </textarea></span>
						    </div>
						   <div>
