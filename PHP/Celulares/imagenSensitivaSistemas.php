    	    ...
    	    <div class="wrap">
    	    		...
    	    		<div class="categories">
						   <ul>
						  	   <h3>Buscar por categorias</h3>
							      ...
							      <li><a href="ordenaPrecio.php">Ordenar por precio $</a></li>
						  	 </ul>
						</div>	
						<!--
    	    	...
    	    	<h3>Resultados por SO</h3>
    	    		...
    	    		<MAP NAME="mapaSistemas">
					  <AREA SHAPE=rect COORDS="0,0,375,449" 
					      HREF="script-filtroSistema.php?sistema='Android'" >

					  <AREA SHAPE=rect COORDS="376,0,750,449" 
					      HREF="script-filtroSistema.php?sistema='ios' " >
					</MAP>
